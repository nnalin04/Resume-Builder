    ...
    <div id="resume-preview" style={{
      ...
      {projects.length > 0 && (
        <div style={{ marginBottom: 14, breakInside: 'avoid' as const, pageBreakInside: 'avoid' as const }}>
          ...
          {projects.map((proj, i) => (
            <div key={i} style={{ marginBottom: 6, breakInside: 'avoid' as const, pageBreakInside: 'avoid' as const }}>
...
function RuledSection({ title, f }: { title: string; f: (n: number) => number }) {
  return (
    <div style={{ marginBottom: 7, breakInside: 'avoid' as const, pageBreakInside: 'avoid' as const }}>
